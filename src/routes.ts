...
import GoodsStatistic from '@/pages/buyer/Statistics/Goods';
import SupplierSelect from '@/pages/buyer/Supplier/Selection';
...
const routerConfig = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: '/buyer/goodsStatistic',
        component: GoodsStatistic,
        exact: true
      }
    ]
  }
